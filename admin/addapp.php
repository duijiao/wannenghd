    ...
    <main class="lyear-layout-content">
      ...
      <div class="container-fluid p-t-15">
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="card">
              <header class="card-header"><div class="card-title">添加应用</div></header>
              <div class="card-body">
                ...
                <form class="form-horizontal" action="#" method="post" enctype="multipart/form-data" onsubmit="return false;">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="appsize" placeholder="请输入应用大小（MB）">
                  </div>
            <div class="form-group file-group">
              <label for="web_site_logo">应用LOGO</label>
              <div class="input-group">
                <input type="text" class="form-control file-value" name="web_site_logo" value="" id="applogo" placeholder="LOGO图片地址" />
            ...
            <div class="form-group file-group">
              ...
              <div class="input-group">
                <input type="text" class="form-control file-value" name="web_site_logo" value="" id="appimg1" placeholder="应用截图地址" />
                <input type="file" accaccept=".png,.jpg,.jpeg,.bmp,.gif" class="d-none" />
                <div class="input-group-append">
                  <button class="btn btn-default file-browser" type="button">上传图片</button>
                </div>
            ...
            <div class="form-group file-group">
              ...
              <div class="input-group">
                <input type="text" class="form-control file-value" name="web_site_logo" value="" id="appimg2" placeholder="应用截图地址2" />
                <input type="file" accaccept=".png,.jpg,.jpeg,.bmp,.gif" class="d-none" />
                <div class="input-group-append">
                  <button class="btn btn-default file-browser" type="button">上传图片</button>
                </div>
            ...
            <div class="form-group file-group">
              ...
              <div class="input-group">
                <input type="text" class="form-control file-value" name="web_site_logo" value="" id="appimg3" placeholder="应用截图地址3" />
                <input type="file" accaccept=".png,.jpg,.jpeg,.bmp,.gif" class="d-none" />
                <div class="input-group-append">
                  <button class="btn btn-default file-browser" type="button">上传图片</button>
                </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="appurl" placeholder="请输入应用下载链接">
                  </div>

                  <div class="form-group">
                    <label for="exampleFormControlTextarea1">应用介绍</label>
                    <textarea class="form-control" id="appintro" rows="3" placeholder="请输入应用介绍"></textarea>
                  </div>
            ...
            <div class="form-group">
              ...
              <select class="form-control" id="appvipstatus">
                ...
                <option value="0">免费</option>';
                    ...
                    <button class="btn btn-block btn-primary" id="addapp">添加</button>
